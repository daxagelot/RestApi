                 ...
                 <form action="{{ route('store.review') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">New Review Add Form</h3>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="p-0 form-control form-control-sm @error('profile') is-invalid @enderror" id="profile"
                                        name="profile">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        name="designation" placeholder="Enter Designation" value="{{old('designation')}}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        name="rating" placeholder="Enter Rating" value="{{old('rating')}}">
