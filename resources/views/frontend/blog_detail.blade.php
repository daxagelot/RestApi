        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8">
            ...
            <article class="article">
              ...
              <div class="meta-top">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="{{route('blog_detail')}}">John Doe</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="{{route('blog_detail')}}"><time datetime="2020-01-01">Jan 1, 2022</time></a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="{{route('blog_detail')}}">12 Comments</a></li>
                </ul>
              </div><!-- End meta top -->
            ...
            <div class="comments">
              ...
              <div id="comment-1" class="comment">
                <div class="d-flex">
                  <div class="comment-img"><img src="{{asset('frontend/assets/img/blog/comments.jpg')}}" alt=""></div>
                  <div>
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item recent-posts">
                ...
                <div class="post-item">
                  ...
                  <div>
                    <h4><a href="{{route('blog_detail')}}">Nihil blanditiis at in nihil autem</a></h4>
                ...
                <div class="post-item">
                  ...
                  <div>
                    <h4><a href="{{route('blog_detail')}}">Quidem autem et impedit</a></h4>
                    <time datetime="2020-01-01">Jan 1, 2020</time>
                  </div>
                </div><!-- End recent post item-->
                ...
                <div class="post-item">
                  ...
                  <div>
                    <h4><a href="{{route('blog_detail')}}">Id quia et et ut maxime similique occaecati ut</a></h4>
                    <time datetime="2020-01-01">Jan 1, 2020</time>
                  </div>
                </div><!-- End recent post item-->
                ...
                <div class="post-item">
                  ...
                  <div>
                    <h4><a href="{{route('blog_detail')}}">Laborum corporis quo dara net para</a></h4>
                    <time datetime="2020-01-01">Jan 1, 2020</time>
                  </div>
                </div><!-- End recent post item-->
                ...
                <div class="post-item">
                  ...
                  <div>
                    <h4><a href="{{route('blog_detail')}}">Et dolores corrupti quae illo quod dolor</a></h4>
                    <time datetime="2020-01-01">Jan 1, 2020</time>
                  </div>
                </div><!-- End recent post item-->
