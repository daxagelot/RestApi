        ...
        <div class="row gy-4 posts-list">
          ...
          <div class="col-xl-4 col-lg-6">
            <article>
              ...
              <h2 class="title">
                <a href="{{route('blog_detail')}}">Non rem rerum nam cum quo minus olor distincti</a>
              </h2>
          ...
          <div class="col-xl-4 col-lg-6">
            <article>
              ...
              <h2 class="title">
                <a href="{{route('blog_detail')}}">Accusamus quaerat aliquam qui debitis facilis consequatur</a>
              </h2>
          ...
          <div class="col-xl-4 col-lg-6">
            <article>
              ...
              <h2 class="title">
                <a href="{{route('blog_detail')}}">Distinctio provident quibusdam numquam aperiam aut</a>
              </h2>
