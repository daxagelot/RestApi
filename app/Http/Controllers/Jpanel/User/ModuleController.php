...
class ModuleController extends Controller
{
    ...
    public function updateModule (Request $request,$module_id){
        ...
        $module = Module::where('id', $module_id)->update(['name' => $request->pname, 'slug' => $request->slug,'updated_by'=>Auth::id()]);
        if ($module) {
    ...
    {
        Module::where('id',$request->module_id)->update(['deleted_by'=>Auth::id()]);
